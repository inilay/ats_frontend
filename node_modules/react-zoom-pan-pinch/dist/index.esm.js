import React, { useState, useRef, useMemo, useImperativeHandle, useEffect, useContext } from 'react';
...
function isValidZoomNode(node) {
    ...
    if ((node === null || node === void 0 ? void 0 : node.offsetWidth) === undefined || (node === null || node === void 0 ? void 0 : node.offsetHeight) === undefined) {
...
var ZoomPanPinch = /** @class */ (function () {
    function ZoomPanPinch(props, onChange) {
        var _this = this;
        ...
        this.setTransformState = function (scale, positionX, positionY) {
            ...
            if (!Number.isNaN(scale) &&
                ...
                (_a = _this.onChange) === null || _a === void 0 ? void 0 : _a.call(_this, ctx);
                handleCallback(ctx, { scale: scale, positionX: positionX, positionY: positionY }, onTransformed);
                _this.applyTransformation();
            }
            else {
...
var TransformWrapper = React.forwardRef(function (props, ref) {
    ...
    var children = props.children, performance = props.performance;
    var instance = useRef(new ZoomPanPinch(props, function () {
        if (!performance) {
    ...
    var value = useMemo(function () {
        return __assign(__assign({}, instance.transformState), { setComponents: instance.init, contextInstance: instance });
